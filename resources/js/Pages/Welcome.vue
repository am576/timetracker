            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                    <div class="flex lg:justify-center lg:col-start-2">
                        <img class="logo" :src="'/storage/clock.png'" alt="">
                    </div>
                    <nav v-if="canLogin" class="-mx-3 flex flex-1 justify-end">
                        ...
                        >
                            <span class="mr-3">{{ $page.props.auth.user.name }}</span> Управление
                        </Link>
                ...
                <main class="mt-6 flex justify-center">
                    <div class="projects-list flex flex-col gap-6 w-50">
                        <h3>Недавние проекты</h3>
                        <div class="project-card" v-for="project in projects">
                            <span>{{ project.name }}</span>
                            <span>{{ project.user.name }}</span>
                            <span>{{ moment(project.created_at).utc().format("DD.MM.YYYY")}}</span>
                        </div>
                    </div>
...
.project-card {
    ...
    padding: 20px;
    border-radius: 10px;
    -webkit-box-shadow: 5px 2px 5px 0px rgba(0,0,0,0.32);
    -moz-box-shadow: 5px 2px 5px 0px rgba(0,0,0,0.32);
    box-shadow: 5px 2px 5px 0px rgba(0,0,0,0.32);
